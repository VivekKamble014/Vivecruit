                        ...
                        <div key={interview.id} className='border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors'>
                            <div className='flex justify-between items-start'>
                                <div className='flex-1'>
                                    <h3 className='font-semibold text-lg text-gray-900'>{interview.title || 'Untitled Interview'}</h3>
                                    <p className='text-gray-600 text-sm mt-1'>{interview.description || 'No description'}</p>
                                ...
                                <div className='flex gap-2'>
                                    ...
                                    <Button 
                                        variant="outline" 
                                        size="sm"
                                        onClick={() => router.push(`/dashboard/create-interview?id=${interview.id}`)}
                                    >
                                        Edit
                                    </Button>
                                </div>
